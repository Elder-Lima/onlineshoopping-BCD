...
--
-- Host: 127.0.0.1
-- Tempo de geração: 15-Jun-2023 às 16:27
...
('2839 8219 3728 2933', 9, 'CIBC', '2031-05-20'),
('4023-1231-3431-8623', 18, 'CIBC', '2039-09-10'),
('4457 4992 7391 0219', 32, 'BMO', '2025-08-30'),
('4509 4462 9302 0716', 3, 'CIBC', '2030-01-30'),
('4902 9212 3402 8831', 5, 'CIBC', '2027-07-01'),
('5728 8391 7362 5381', 30, 'CIBC', '2035-05-20'),
('5782 7293 8472 0318', 1, 'CIBC', '2028-08-15'),
('5872 8293 3321 0123', 15, 'BMO', '2020-05-14'),
('7283 8982 8361 5593', 24, 'BMO', '2029-04-14'),
('8473 9299 8492 7361', 41, 'BMO', '2024-06-20'),
('9238 2749 5738 5921', 12, 'CIBC', '2027-08-01');
...
(39, 87291231, '00:20:17'),
(1, 12992012, '00:20:15'),
(7, 76023921, '00:20:15'),
(12, 59203012, '00:20:17'),
(14, 93042135, '00:20:15');
...
INSERT INTO `orders` (`orderNumber`, `paymentStatus`, `creationTime`, `totalAmount`) VALUES
(12992012, 'Paid', '2015-05-30 00:00:00', '203.00'),
(23924831, 'Paid', '2014-03-22 00:00:00', '174.00'),
(58293123, 'Unpaid', '2016-12-27 00:00:00', '928.00'),
(59203012, 'Paid', '2017-02-12 00:00:00', '87.00'),
(72839301, 'Unpaid', '2015-02-13 00:00:00', '293.00'),
(73919231, 'Paid', '2014-02-11 00:00:00', '20.00'),
(74892932, 'UnPaid', '2016-02-19 00:00:00', '77.00'),
(76023921, 'Paid', '2016-09-18 00:00:00', '315.00'),
(83921201, 'Paid', '2017-01-03 00:00:00', '301.00'),
(84821231, 'Paid', '2014-11-02 00:00:00', '18.00'),
(87291231, 'Unpaid', '2017-01-23 00:00:00', '102.00'),
(91027482, 'Unpaid', '2016-12-27 00:00:00', '187.00'),
(93042135, 'Paid', '2015-08-22 00:00:00', '52.00');
...
('4902 9212 3402 8831', 23924831, '00:20:16'),
('4023 1231 3431 8623', 87291231, '00:20:16'),
('8473 9299 8492 7361', 58293123, '00:20:16'),
('7283 8982 8361 5593', 12992012, '00:20:15'),
('9238 2749 5738 5921', 59203012, '00:20:13'),
('4902 9212 3402 8831', 91027482, '00:20:17'),
('4902 9212 3402 8831', 72839301, '00:20:16'),
('4023 1231 3431 8623', 93042135, '00:20:16'),
('7283 8982 8361 5593', 91027482, '00:20:17'),
('9238 2749 5738 5921', 84821231, '00:20:17'),
('9238 2749 5738 5921', 73919231, '00:20:16'),
('9238 2749 5738 5921', 83921201, '00:20:17');
...
CREATE TABLE `product` (
  ...
  `customerReview` decimal(3,1) DEFAULT NULL,
...
INSERT INTO `product` (`pid`, `sid`, `brand`, `name`, `type`, `modelNumber`, `colour`, `customerReview`, `amount`) VALUES
(1, 8, 'Asus', 'ASUS Chromebook 11.6 laptop', 'laptop', 'C201PA-DS02', 'navy blue', '10.0', 262),
(2, 10, 'Bose', 'Bose QuietComfort 35 wireless headphone', 'headphone', '759944-0010', 'black', '99.9', 449),
(3, 39, 'Canon', 'Canon EOS Rebel T5', 'cameras', '9126B003', 'black', '50.0', 500),
(4, 77, 'DELL', 'DELL Ultra HD 4k Monitor P2715Q 27-Inch Screen LED-Lit Monitor', 'computer accessories', 'P2715Q', 'black', '40.0', 713),
(5, 218, 'GoPro', 'GoPro HERO5', 'cameras', 'CHDHX-501-CA', 'black', '80.0', 599),
(6, 218, 'Microsoft', 'Microsoft Xbox 360 Wired Controller for Windows', 'controllers', '52A-00004', 'black', '60.0', 35),
(7, 8, 'Microsoft', 'Microsoft Sculpt Ergonomic Wireless Bluetrack Desktop Keyboard', 'computer accessories', 'L5V-00003', 'black', '70.0', 126),
(8, 8, 'Microsoft', 'Microsoft Surface Pro 4 i5 (128GB) with Wireless Media Adapter', 'laptop', 'CR5-00001', 'black', '30.0', 1350);
...
CREATE TABLE `store` (
  ...
  `city` varchar(255) DEFAULT NULL,
  `streetAddr` varchar(255) DEFAULT NULL,
  `customerGrade` decimal(3,2) DEFAULT NULL,
...
(8, 'Choby Collection', 'Quebec', 'Montreal', 'No.2012 Sanguinet', '4.00', '00:20:06'),
(10, 'BestBuy', 'British Columbia', 'Vancouver', 'No.20 ShineStreet', '5.00', '00:20:02'),
(39, 'CoolGuy', 'Quebec', 'Montreal', 'No.1023 St-Catherine', '3.00', '00:20:12'),
(77, 'Your Favorite', 'Ontario', 'Toronto', 'No.3022 Saint Denis', '4.00', '00:20:15'),
(218, 'American Eagle', 'Quebec', 'Quebec city', 'No.5 Berri Street', '2.00', '00:20:04');
...
--
-- Limitadores para a tabela `bankcard`
--
ALTER TABLE `bankcard`
...
ALTER TABLE `payment`
  ...
  ADD CONSTRAINT `payment_ibfk_2` FOREIGN KEY (`orderNumber`) REFERENCES `orders` (`orderNumber`);
